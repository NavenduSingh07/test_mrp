...
// Retrieve success a barcode data from URL parameters
...
<head>
    <title>Damage Product Barcode Scanner</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<body>
    <h2 class="text-center">Record Damages for Received Stock</h2>
    <?php
    // Success barcode messages
    $message = "";
    if (!empty($success_barcodes)) {
        $message .= "Damages successfully stored for lot:\\n" . implode("\\n", $success_barcodes) . "\\n\\n";
    }
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-8">
                <form id="barcodeForm" method="post" action="store_damages.php">
